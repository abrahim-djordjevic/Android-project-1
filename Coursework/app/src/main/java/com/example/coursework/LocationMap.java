...
public class LocationMap extends AppCompatActivity {
    ...
    public int obtainData() {
        try {
            URL search = new URL("http://sandbox.kriswelsh.com/hygieneapi/hygiene.php?op=search_postcode&postcode="+location);
    ...
    public void popTable(){
        TableLayout table = findViewById(R.id.tablelocation);
