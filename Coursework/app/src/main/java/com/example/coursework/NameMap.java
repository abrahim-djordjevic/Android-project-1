...
public class NameMap extends AppCompatActivity{
    String fullname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_name_map);
    ...
    public int obtainData(){
        try {
            URL search = new URL("http://sandbox.kriswelsh.com/hygieneapi/hygiene.php?op=search_name&name="+fullname);
